 ...
 */
require_once plugin_dir_path(__FILE__).'multicacheoptimize.php';
require_once plugin_dir_path(__FILE__).'multicachejsoptimize.php';
require_once plugin_dir_path(__FILE__).'multicachecssoptimize.php';
